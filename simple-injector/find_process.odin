...
// Parameters:
//   process_name: The name of the process to find (e.g., "notepad.exe")
// Returns:
//   bool: true if the process was found, false otherwise
//   u32: Process ID (PID) of the found process (0 if not found)
find_process_by_name :: proc(process_name: string) -> (bool, u32) {
	...
	// Process not found - return failure with PID 0
	return false, 0
}
